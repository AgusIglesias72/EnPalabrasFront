...
export const mockDataTeam = [
  ...
  },
  {
    id: 6,
    currency: 'USD',
    nombre: 'Ever Mercado Libresandre',
    email: 'everMercado Libresandre@gmail.com',
    age: 150,
    ingresos: '3000',
    canalVenta: 'Mercado Libre',
...
export const mockLineData = [
  {
    id: 'japan',
    color: modes('dark').greenAccent[500],
    data: [
      {
        x: 'plane',
        y: 101,
  ...
  {
    id: 'france',
    color: modes('dark').blueAccent[300],
    data: [
      {
        x: 'plane',
        y: 212,
  ...
  {
    id: 'us',
    color: modes('dark').redAccent[200],
    data: [
      {
        x: 'plane',
        y: 191,
